...
SEED=${SEED:-0}
OUTPUT_DIR=${OUTPUT_DIR:-"results/models/triplet_seed${SEED}"}
RUN_NAME=${RUN_NAME:-"triplet_seed${SEED}"}
MINING=${MINING:-"hard"}

echo "=========================================="
echo "CLXAI: Triplet Loss Training (Seed ${SEED})"
echo "=========================================="
...
# Run training with triplet loss
echo "Starting Triplet training with seed ${SEED}..."
