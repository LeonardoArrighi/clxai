...
SEED=${SEED:-0}
OUTPUT_DIR=${OUTPUT_DIR:-"results/models/ce_seed${SEED}"}
RUN_NAME=${RUN_NAME:-"ce_seed${SEED}"}

echo "=========================================="
echo "CLXAI: Cross-Entropy Training (Seed ${SEED})"
echo "=========================================="
...
echo "Starting CE training with seed ${SEED}..."
