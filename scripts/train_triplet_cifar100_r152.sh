...
#SBATCH --output=logs/slurm/triplet_cifar100_r152_%j.out
#SBATCH --error=logs/slurm/triplet_cifar100_r152_%j.err

echo "=========================================="
echo "CLXAI: Triplet Loss - CIFAR-100 + ResNet-152"
echo "=========================================="
...
# Create directories
mkdir -p logs/slurm results/models/cifar100_r152/triplet wandb
