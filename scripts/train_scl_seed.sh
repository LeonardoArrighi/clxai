...
SEED=${SEED:-0}
OUTPUT_DIR=${OUTPUT_DIR:-"results/models/scl_seed${SEED}"}
RUN_NAME=${RUN_NAME:-"scl_seed${SEED}"}

echo "=========================================="
echo "CLXAI: Supervised Contrastive Learning (Seed ${SEED})"
echo "=========================================="
...
echo "Starting SCL training with seed ${SEED}..."
